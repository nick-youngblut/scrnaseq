process CELLRANGER_MULTI {
    ...
    fb_options_r1_length = fb_options_use && fb_options.containsKey("r1-length") ? "r1-length,${fb_options["r1-length"]}" : ''
    fb_options_r2_length = fb_options_use && fb_options.containsKey("r2-length") ? "r2-length,${fb_options["r2-length"]}" : ''
